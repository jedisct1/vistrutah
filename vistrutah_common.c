...
const uint8_t ROUND_CONSTANTS[16 * 48] = {
...
const uint8_t VISTRUTAH_P4[16] = { 9, 7, 13, 14, 0, 10, 3, 5, 1, 2, 15, 4, 6, 12, 11, 8 };
const uint8_t VISTRUTAH_P5[16] = { 12, 8, 1, 9, 15, 4, 0, 3, 14, 10, 6, 7, 2, 5, 13, 11 };

// Inverse permutation tables for decryption
const uint8_t VISTRUTAH_P4_INV[16] = { 4, 8, 9, 6, 11, 7, 12, 1, 15, 0, 5, 14, 13, 2, 3, 10 };
