...
benchmark_vistrutah_256()
{
    ...
    for (int i = 0; i < NUM_BLOCKS; i++) {
        vistrutah_256_encrypt(data + i * BLOCK_SIZE, output + i * BLOCK_SIZE, key, 32,
    ...
    start = get_time();
    for (int i = 0; i < NUM_BLOCKS; i++) {
        vistrutah_256_decrypt(output + i * BLOCK_SIZE, data + i * BLOCK_SIZE, key, 32,
                              VISTRUTAH_256_ROUNDS_LONG);
    }
...
benchmark_vistrutah_512()
{
    ...
    double start = get_time();
    for (int i = 0; i < NUM_BLOCKS; i++) {
        vistrutah_512_encrypt(data + i * BLOCK_SIZE, output + i * BLOCK_SIZE, key256, 32,
    ...
    start = get_time();
    for (int i = 0; i < NUM_BLOCKS; i++) {
        vistrutah_512_encrypt(data + i * BLOCK_SIZE, output + i * BLOCK_SIZE, key512, 64,
